CREATE OR REPLACE TABLE `your_project_id.orders.customers` AS
SELECT
...
SELECT
    ...
    CAST('2025-09-02 09:15:00+10' AS TIMESTAMP) AS `updated_at`
UNION ALL
SELECT
    ...
    CAST('2025-09-03 10:30:00+10' AS TIMESTAMP) AS `updated_at`
UNION ALL
SELECT
    ...
    CAST('2025-09-04 11:45:00+10' AS TIMESTAMP) AS `updated_at`
UNION ALL
SELECT
...
CREATE OR REPLACE TABLE `your_project_id.orders.orders` AS
SELECT
    CAST(1 AS INT64) AS `id`,
...
CREATE OR REPLACE TABLE `your_project_id.orders.order_items` AS
SELECT
    CAST(1 AS INT64) AS `id`,
